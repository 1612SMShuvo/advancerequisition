                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{__('Coupon Price Range ')}} *</h4>
                                <p class="sub-heading">{{ __('(Price Range)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="coupon_price_range" placeholder="{{ __('Price Range') }}" required="" value="{{ $data->coupon_price_range }}">
                          </div>
                        </div>
