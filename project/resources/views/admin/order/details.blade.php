                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value , 0) }}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Ordered Date') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{date($order->created_at)}}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Shipping Slot') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{ (($order->shipping_time)) }}</td>
                                                </tr>
                                                <tr>
