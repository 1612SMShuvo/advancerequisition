    ...
    <div class="order-table-wrap">
        <div class="invoice-wrap">
            ...
            <div class="row invoice__metaInfo mb-4">
                <div class="col-lg-6">
                    <div class="invoice__orderDetails">
                        ...
                        <span><strong>{{ __('Order Date') }} :</strong> {{ date($order->created_at) }}</span><br>
                ...
                <div class="col-lg-6">
                        <div class="invoice__orderDetails">
                            ...
                            <span><strong>{{ __('Company Name') }}</strong>: {{__('Advance E-commerce')}}</span><br>

                             <span><strong>{{ __('Web') }}</strong>: {{__('https://webasesolutions.com/')}}</span><br>

                            <span><strong>{{ __('Address') }}</strong>: {{__('27/C, Block E, Asad Avenue, Mohammadpur, Dhaka-1207.')}}</span><br>

                            <span><strong>{{ __('Phone') }}</strong>: {{__('01879186653')}}</span><br>

                            <span><strong>{{ __('E-mail') }}</strong>: {{ __('hello@webase.com.bd') }}</span>
                        </div>
                </div>
            </div>
            <div class="row invoice__metaInfo">
                ...
                <div class="col-lg-6">
                        <div class="buyer">
                            <p><h5><b>{{ __('Billing Details') }}</b></h5></p>
                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($subtotal, 0) }}</td>
                                        </tr>
                                        ...
                                        <td>{{$order->currency_sign}}{{ $subtotal }}</td>
                                            {{-- <td>{{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value , 0) }}</td> --}}
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
