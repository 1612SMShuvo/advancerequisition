...
@section('content')  {{-- 
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Discount Section') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
											</li>
											<li>
												<a href="{{ route('admin-coupon-index') }}">&nbsp;&nbsp;{{ __('Discount') }}</a>
											</li>
										</ul>
								</div>
							</div>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        ...
									                        <th>{{ __('Discount(% or ৳)') }}</th>
									                        <th>{{ __('Discount Price') }}</th>
									                        <th>{{ __('Conditional Price') }}</th>
									                        <th>{{ __('Maximum(Unit)') }}</th>
									                        <th>{{ __('Status') }}</th>
									                        <th>{{ __('Options') }}</th>
														</tr>
													</thead>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               columns: [
                        ...
                        { data: 'conditional_price', name: 'conditional_price' },
