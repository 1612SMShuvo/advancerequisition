										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-user-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="city" placeholder="{{ __('Current_City') }}" value="{{ $data->city }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="address" placeholder="{{ __('Address') }}" value="{{ $data->address }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="number" class="input-field" name="phone" placeholder="{{ __('Phone') }}" pattern="[0-9]{11}" value="{{ $data->phone }}">
													</div>
												</div>
