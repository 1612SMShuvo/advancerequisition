                      ...
                      <form id="geniusform" action="{{route('admin-role-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="report"  {{ $data->sectionCheck('report') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                            <div class="col-lg-4 d-flex justify-content-between">
                              <label class="control-label">{{ __('Send SMS') }} *</label>
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="bulksms" {{ $data->sectionCheck('bulksms') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              <label class="control-label">{{ __('Discounts') }} *</label>
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="discount" {{ $data->sectionCheck('discount') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
