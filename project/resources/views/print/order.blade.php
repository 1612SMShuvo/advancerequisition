...
<body>
    <div class="invoice-wrap">
            ...
            <div class="invoice__metaInfo" >
                <div class="col-lg-6">
                        <div class="invoice__orderDetails">
                            <p><strong>{{ __('Company Details') }}</strong></p>
                            <span><strong>{{ __('Company Name') }}</strong>: {{__('Marn Bazar')}}</span><br>

                             <span><strong>{{ __('Web') }}</strong>: {{__('www.marnbazar.com')}}</span><br>

                            <span><strong>{{ __('Address') }}</strong>: {{__('House # 09 (2nd Floor), # Garib-E-Newaz Avenue, Sector # 11, Uttara, Dhaka-1230, Bangladesh.')}}</span><br>

                            <span><strong>{{ __('Phone') }}</strong>: {{__('01914242440, 01914242445')}}</span><br>

                            <span><strong>{{ __('E-mail') }}</strong>: {{ __(' info@marnbazar.com') }}</span>
                        </div>
                </div>
            </div>
                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               @if($product['color'])
                                                ...
                                                @endif
                                                <p>
                                                        Price : {{ App\Models\Currency::where('sign',$order->currency_sign)->first()->name }}{{ round($product['item']['price'] * $order->currency_value , 0) }}
                                                </p>
                                               <p>
                                            ...
                                            <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->name }}{{ round($product['price'] * $order->currency_value , 0) }}
                                            </td>
                                            @php
                                        ...
                                        <tr class="semi-border">
                                            ...
                                            <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->name }}{{ round($subtotal, 0) }}</td>
                                        ...
                                        @if($order->coupon_discount != null)
                                            ...
                                            <td>{{round($order->coupon_discount, 0)}}</td>
                                        ...
                                        <tr class="final-border">
                                            ...
                                            <td>{{$order->currency_sign}}{{ $subtotal }}</td>
                                            {{-- <td>{{ App\Models\Currency::where('sign',$order->currency_sign)->first()->name }}{{ round($order->pay_amount * $order->currency_value , 0) }}
                                            </td> --}}
                                        </tr>
