...
<head>
    <meta name="facebook-domain-verification" content="ezudbiacz7gt09dpukmqljtjocmhpd" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-180938432-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-180938432-1');
</script>
...
})(window,document,'script','dataLayer','GTM-TTM7C38');</script>
...
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-NK5J8F6');</script>
<!-- End Google Tag Manager -->
...
fbq('init', '372669414141172');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=372669414141172&ev=PageView&noscript=1"
/></noscript>
	...
	<div class="modal" id="myModal">
	    <div class="modal-dialog">
	    	<div class="modal-content">
        		...
        		<button type="button" style="padding: 20px;" class="close" data-dismiss="modal">&times;</button><br>
		       	<center class="p-3">
		       		<a href="{{ route('front.index') }}">
						<img src="{{asset('assets/images/'.$gs->logo)}}" alt="">
					</a>
			       	<h4 class="modal-title" style="color: black;">Register & Get Specieal Services</h4><br>
		      <br>
              
                  {{--Success message--}}
                  <p class="alert-success" id="reg_success_msg"></p>
                  {{--Error message--}}
                  <p class="alert-danger" id="reg_error_msg"></p>
                  {{--Un register message--}}
                  ...
                  <p class="alert-warning" id="reg_warning_msg"></p>
						...
						<div class="myform form ">			
							<form action="" method="POST">
								...
								<div class="form-group row">
									<div class="col-sm-1 col-md-1 col-lg-1" style="background-color: #78d46a;margin-left: 14px;margin-right: -14px;">
										<i class="fas fa-user-tie" style="margin-top: 10px;"></i>
									</div>
								...
								<div class="form-group row">
									<div class="col-sm-1 col-md-1 col-lg-1" style="background-color: #78d46a;margin-left: 14px;margin-right: -14px;">
										<i class="fas fa-envelope-open-text" style="margin-top: 10px;"></i>
									</div>
									<div class="col-sm-11 col-md-11 col-lg-11">
									    <input type="email" class="form-control" name="email" placeholder="{{ $langg->lang183 }}" id="reg_email" required="">
									</div>
								</div>
								<div class="pl-2 pr-2">
									<p id="email_error" class="text-warning"></p> <p id="email_success" class="text-success"></p> <p id="email_unique_error" class="text-danger"></p>
								</div>
			                  	<div class="form-group row">
			                  		<div class="col-sm-1 col-md-1 col-lg-1" style="background-color: #78d46a;margin-left: 14px;margin-right: -14px;">
										<i class="fas fa-mobile-alt" style="margin-top: 10px;margin-left: 2px;"></i>
									</div>
									<div class="col-sm-9 col-md-9 col-lg-9">
			                    		<input type="number" name="phone" class="form-control" pattern="[0-9]{11}" id="reg_phone" placeholder="{{ $langg->lang184 }}"
			                           required="">
			                       	</div>
									<div class="col-sm-2 col-md-2 col-lg-2">
										<a class="btn btn-success" id="send_btn" style="float: right; color: white;">Send</a>
									</div>
			                  	</div>

			                  	<div class="form-group row">
									<div class="col-sm-1 col-md-1 col-lg-1" style="background-color: #78d46a;margin-left: 14px;margin-right: -14px;">
										<i class="fas fa-mask" style="margin-top: 10px;margin-left: -3px;"></i>
									</div>
									<div class="col-sm-11 col-md-11 col-lg-11">
			                    		<input type="text" class="form-control" id="user_otp" name="otp" placeholder="Confirmation code.."
			                             required="">
			                         </div>
			                  	</div>
								<div class="form-group row">
									<div class="col-sm-1 col-md-1 col-lg-1" style="background-color: #78d46a;margin-left: 14px;margin-right: -14px;">
										<i class="fas fa-unlock"style="margin-top: 10px;"></i>
									</div>
									<div class="col-sm-11 col-md-11 col-lg-11">								    
                                ...
                                <input type="hidden" name="client_request" value="true">
								<center>
									<button type="submit" name="buttonreg" value="pressed" class="btn btn-success">{{$langg->lang189}}
								    </button>
								</center>
							</form>
						</div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TTM7C38"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NK5J8F6"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
            ...
            <div class="subscribePreloader__text text-center">
                ...
                <form action="{{route('front.subscribe')}}" id="subscribeform" method="POST">
                    ...
                    <div class="form-group">
                        <input type="email" name="email"  placeholder="Enter Your Phone Number" required="">
...
<div class="header-section">
	<section class="top-header">
		<div class="container follw">
			<div class="row">
				<div class="col-lg-12 remove-padding">
					<div class="content">
						<div class="left-content">
							<div class="categories_menu mmenu">
								<div class="categories_title">
									<h2 class="categori_toggle"><i class="fa fa-bars"></i></h2>
								</div>
							...
							<div class="list">
								<ul>
                        			...
                        			@if($gs->reg_vendor == 1)
                        				...
                        				@else
										<li>
											<a href="javascript:;" data-toggle="modal" data-target="#vendor-login" class="tbtn">Seller Point<!-- {{ $langg->lang220 }} --></a>
										</li>
										@endif
									@endif

									<!-- <a href="javascript:;" data-toggle="modal" data-target="#track-order-modal" class="track-btn tbtn">{{ $langg->lang16 }}</a> -->
		...
		<div class="container">
			<div class="row ">
				...
				<div class="col-lg-8 col-sm-12 remove-padding order-last order-sm-2 order-md-2">
					...
					<!-- <a class="oldsitebtn" href="https://marnbazar.com/old">OldSite +</a> -->
					</div>
...
<!-- DISCOUNT MODAL -->
	...
	<div class="modal fade" id="discount-modal" tabindex="-1" role="dialog" aria-labelledby="popup-discount-modal" aria-hidden="true">
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
	            <div class="modal-header">
	                <h6 class="modal-title"> <b>{{ 'Discount Messages' }}</b> </h6>
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                <span aria-hidden="true">&times;</span>
	                </button>
	            </div>
...
//                       $('#email_success').text("Email is unique.");
// 					  $('#email_unique_error').text(" ");
// 					  $("#email_error").text(" ");
//                   }
// 				  else{
//                       $('#email_unique_error').text("Email is already taken.");
// 					  $('#email_success').text(" ");
// 					  $("#email_error").text(" ");
// 				  }
//               },
...
//                       $('#reg_success_msg').text("Confirmation code has been sent to your phone.");
// 					  $('#reg_error_msg').text(" ");
// 					  $('#reg_warning_msg').text(" ");
//                   }else if(msg == "registered"){
//                       $('#reg_warning_msg').text("You are already registered with this number! Try with another number.");
// 					  $('#reg_success_msg').text(" ");
// 					  $('#reg_error_msg').text(" ");
//                   }else{
//                       $('#reg_error_msg').text("Something went wrong.Try again...");
// 					  $('#reg_success_msg').text(" ");
// 					  $('#reg_warning_msg').text(" ");
//                   }
//               }
