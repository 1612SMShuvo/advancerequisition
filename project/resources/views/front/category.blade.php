           ...
           <div class="col-lg-12 order-first order-lg-last ajax-loader-parent">
              <div class="right-area" id="app">
                 ...
                 <div class="categori-item-area">
                  ...
                  <div id="loading" class="ajaxLoading text-center" style="display: none">
                    <img src="{{ asset('/assets/images/1603709667loading.gif') }}" />
                  </div>
  ...
  $( document ).ready(function() {
      ...
      $("#loadMore").on('click',function(){
        //show loader
          ...
          var getData = $('#ajaxContent').outerHTML();
          var finalData = getData.replace('ajaxContent','');

          //Define url for loading
          var fullUrl = setFullUrl(page);
          //load content
          $('#ajaxContent').load(fullUrl);

          //Append data to previous class
          $('#load-more').append(finalData);
          //var finalData = '';
      ...
      //Set full url for ajax............
      function setFullUrl(pageNum){
