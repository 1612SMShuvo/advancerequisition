<li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
            ...
            <li>
                <a href="{{route('admin-order-declined')}}"> {{ __('Cancelled Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-ondelivery')}}"> {{ __('On Delivery Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-create')}}"> {{ __('Create custom order') }}</a>
            </li>
    ...
    <li>
        <a href="#report" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('Report ') }}</a>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('create_customer_page') }}"><span>{{ __('Create New Customer') }}</span></a>
            </li>
        </ul>
    </li>
    ...
    <li>
        <a href="#bulkSms" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-ui-user-group"></i>{{ __('Send Sms') }}
        </a>
        <ul class="collapse list-unstyled" id="bulkSms" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-send-single-sms') }}"><span>{{ __('Single or Multiple Sms') }}</span></a>
            </li>
    ...
    <li>
        <a href="#msg" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fab fa-discourse"></i>{{ __('Discount Section') }}
        </a>
        <ul class="collapse list-unstyled" id="msg" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-discount-index') }}"><span>{{ __('All Discounts') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-discount-add_page') }}"><span>{{ __('Add New Discount') }}</span></a>
            </li>
        </ul>
    </li>
