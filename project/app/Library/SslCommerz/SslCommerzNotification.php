...
//                    }
    ...
    public function setAdditionalInfo(array $info)
    {
        ...
        $this->data['value_e'] = (isset($info['value_e'])) ? $info['value_e'] : null; // value_d [ string (255) - Extra parameter to pass your meta data if it is needed. Not mandatory]
        $this->data['value_f'] = (isset($info['value_f'])) ? $info['value_f'] : null; // value_d [ string (255) - Extra parameter to pass your meta data if it is needed. Not mandatory]
