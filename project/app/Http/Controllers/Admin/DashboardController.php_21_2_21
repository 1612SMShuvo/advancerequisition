...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $ondelivery = Order::where('status','=','on delivery')->get();
        ...
        return view('admin.dashboard',compact('pending','activation_notify','processing','completed','products','users','blogs','days','sales','pproducts','rorders','poproducts','rusers','referrals','browsers','ondelivery','declined'));
    }
