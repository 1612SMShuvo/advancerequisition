...
class CartController extends Controller
{
    ...
    public function cart()
    {
        ...
        $total_discount_price = Session::get('total_discount_price');

        return view('front.cart', compact('products', 'totalPrice', 'mainTotal', 'tx','total_discount_price'));
    }
    ...
    public function addtocart($id)
    {
        ...
        // $disProd = Discount::where('product_id', '=', $id)->get()->first();
        ...
        // if (!empty($disProd) && $cart->totalPrice >= $disProd->conditional_price) {
        //     $prod->price = $disProd->discount_price;
        // }
    ...
    public function addnumcart()
    {
        ...
        // $discount_product =DB::table('discounts')->where('product_id',$id)->get()->first();
        ...
        // $products_totalPrice_cart = round($cart->totalPrice*84.63);

        // if($discount_product->conditional_price < $products_totalPrice_cart){

        //     #$prod->price =  $discount_product->discount_price/84.63;
        //     if (!empty($prices)) {
        ...
        //     }
        // }elseif($discount_product->conditional_price < $discount_product->price){
        //    # $prod->price =  $discount_product->discount_price/84.63;
    ...
    //     $coupon_price_check = Coupon::where('code', '=', $code)->get()->first();
    //     $coupon_price_range = $coupon_price_check->coupon_price_range;
    //     $shipping_cost = $request->shipping_cost;
    //     $check_total = $total - $shipping_cost;

    //     if ($check_total >= $coupon_price_range) {
    ...
    //                     } else {
    //                         Session::put('already', $code);
    //                         #$total = $total - round($coupon->price) ;
    //                         $total = $total - $_GET['shipping_cost'] - round($coupon->price);
    //                         $data[0] = round($total, 2);
    //                         $data[1] = $code;
    //                         $data[2] = round($coupon->price);
    //                         $data[3] = $coupon->id;
