...
Route::prefix('admin')->group(
    function () {
        ...
        Route::group(
            ['middleware' => 'permissions:report'], function () {


            Route::get('/report/by-day', 'Admin\OrderController@byDay')->name('admin-all-order-by-day');
            Route::get('/report/daily-profitability', 'Admin\OrderController@dailyProfitability')->name('daily-profitability');
        });
        ...
        //------------ ADMIN REPORT SECTION ------------
        Route::group(
            ['middleware' => 'permissions:bulksms'], function () {


            Route::get('/send/single-sms', 'Admin\MessageController@showSingleSmsForm')->name('admin-send-single-sms');
            Route::post('/send/single-sms', 'Admin\MessageController@insertShowSingleSmsForm')->name('insertShowSingleSmsForm');
        ...
        Route::group(
            ['middleware' => 'permissions:orders'], function () {
            ...
            Route::get('/orders/by-day', 'Admin\OrderController@byDay')->name('admin-all-order-by-day');
            ...
            Route::get('/order/print/all', 'Admin\OrderController@printAllOrder')->name('admin-order-print-all');
            ...
            Route::get('/orders/month-order', 'Admin\OrderController@MetricsbyMonth')->name('month-order');
            ...
            //Custom Order create starts
            Route::get('create-custom-order', 'Admin\OrderController@createCustomOrder')->name('admin-order-create');
            Route::get('get-customer-phone/{id}', 'Admin\OrderController@getCustomerNumber')->name('admin-get-number');


            //Custom Order create ends
        ...
        Route::group(
            ['middleware' => 'permissions:products'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:affilate_products'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:customers'], function () {
            ...
            Route::get('/user/create_customer', 'Admin\UserController@createcustomer')->name('create_customer_page');
            Route::post('/user-create', 'User\RegisterController@user_login_from_admin')->name('user-create_&_login-only');
        ...
        Route::group(
            ['middleware' => 'permissions:vendors'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:vendor_subscription_plans'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:categories'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:bulk_product_upload'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:product_discussion'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:set_coupons'], function () {
        ...
        //------------ ADMIN DISCOUNT SECTION STARTS------------

        Route::group(
            ['middleware' => 'permissions:discount'], function () {

            // Route::get('/messages/datatables/{type}', 'Admin\MessageController@datatables')->name('admin-message-datatables');
            Route::get('/discount/index', 'Admin\DiscountCOntroller@index')->name('admin-discount-index');
            Route::get('/findproduct', 'Admin\DiscountCOntroller@findproduct')->name('admin-discount-findproduct');
            Route::get('/discount/datatables', 'Admin\DiscountCOntroller@datatables')->name('admin-discount-datatables');
            Route::get('/create', 'Admin\DiscountCOntroller@adddiscountpage')->name('admin-discount-add_page');
            Route::post('/discount/create', 'Admin\DiscountCOntroller@storediscount')->name('admin-discount-store');
            Route::get('/discount/edit/{id}', 'Admin\DiscountCOntroller@edit')->name('admin-discount-edit');
            Route::post('/discount/edit/{id}', 'Admin\DiscountCOntroller@update')->name('admin-discount-update');
            Route::get('/discount/status/{id1}/{id2}', 'Admin\DiscountCOntroller@status')->name('admin-discount-status');
            Route::get('/discount/delete/{id}', 'Admin\DiscountCOntroller@destroy')->name('admin-discount-delete');
            

        }
        );
        //------------ ADMIN DISCOUNT SECTION ENDS------------


        //------------ ADMIN BLOG SECTION ------------

        Route::group(
            ['middleware' => 'permissions:blog'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:messages'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:general_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:home_page_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:menu_page_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:emails_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:payment_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:social_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:language_settings'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:seo_tools'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:manage_staffs'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:subscribers'], function () {
        ...
        Route::group(
            ['middleware' => 'permissions:super'], function () {
...
Route::prefix('user')->group(
    function () {
        ...
        Route::post('/user-login', 'User\LoginController@confirmLogin')->name('user.confirm.login');
        Route::get('/submit-number', 'User\LoginController@submitNumber')->name('user.number.submit');
        // User Login End
        ...
        Route::post('/user-register', 'User\RegisterController@userRegister')->name('user-register-only');
        Route::get('/register/send-otp', 'User\RegisterController@sendOtp')->name('user-register.send-otp');
...
Route::post('/pay', 'SslCommerzPaymentController@index')->name('gateway.payment');
...
Route::group(
    ['middleware' => 'maintenance'], function () {
